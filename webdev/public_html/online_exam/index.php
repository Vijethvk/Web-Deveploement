...
//echo $_POST['email']." ".$_POST['uname']." ".$_POST['email']." ".$_POST['psw']." ".$_POST['rpsw']." ".$_POST['usn']." ". $_POST['branch']." ". $_POST['sem']."<br>";
  ...
  $query="UPDATE `Student` SET verify='".$verify1."' WHERE email='".$_POST['email']."' LIMIT 1";
         ...
         if(!mysqli_query($link,$query)){
          ...
          $content = "http://vijethvk11-com.stackstaging.com/online_exam/verify.php?verifyaccount=".$verify1."<br>Click link to verify and activate your account</a>";
          $headers = "From: online_exam@tharunms98.000webhostapp.com";
