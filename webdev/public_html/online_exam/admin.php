...
echo $_POST['email']." ".$_POST['uname']." ".$_POST['psw']." ". $_POST['branch']." ". $_POST['sem']."<br>";
  ...
  // header("Location: loggedinpage.php");
      $emailTo = $_POST['email'];
          ...
          $content = "username:- ".$_POST['email']."<br> password:- ".$_POST['psw'];
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"  onclick="document.getElementById('id02').style.display='block'" id="hom">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
 ...
 <form class="modal-content animate" method="post" >
  ...
  echo '<div class="alert alert-warning" role="alert">'.$warning.'</div>';}?>
    ...
    <input list="branch" name="branch" placeholder="Branch">
     <datalist id="branch">
    <option class="dropdown-item" value="1">Computer Science And Engineering </option>
    <option class="dropdown-item" value="2">Electronics And Communication</option>
    <option class="dropdown-item" value="5">Mechanical And Engineering</option>
     <option class="dropdown-item" value="3">Electrical And Engineering</option>
  </datalist>
  

    <input list="sem" name="sem" placeholder="Semester">
     <datalist id="sem">
    <option class="dropdown-item" value="1001">1</option>
    <option class="dropdown-item" value="1002">2</option>
    <option class="dropdown-item" value="1003">3</option>
     <option class="dropdown-item" value="1004">4</option>
     <option class="dropdown-item" value="1005">5</option>
    <option class="dropdown-item" value="1006">6</option>
    <option class="dropdown-item" value="1007">7</option>
     <option class="dropdown-item" value="1008">8</option>
    </datalist>
<br>
<br>
